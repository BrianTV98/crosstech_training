...
class _KampvieState extends State<Kampvie> {
  ...
  void btnCreateAccount() {
    if (inputUserName.isEmpty || inputEmailAddress.isEmpty || inputPassword.isEmpty || inputComfirm.isEmpty) {
      showDialog(
          context: context,
          builder: (context) {
            return AlertDialog(
      ...
      if (!checkPassword(inputComfirm)) {
        ...
        showDialog(
            ...
            builder: (context) {
              return AlertDialog(
                title: const Text('Thông báo'),
                content: const Text('Vui lòng kiểm tra lại password và confirm'),
                actions: [
                  TextButton(
                    child: const Text('OK'),
                    onPressed: () {
  ...
  bool checkPassword(String password) {
    ...
    if (password.length < 8) {
      ...
      if (hasUpper == false || hasLower == false || hasDigital == false || hasSpecialCharacted == false) {
        return false;
      }
    }
              ...
              children: [
                Container(
                  ...
                  decoration: const BoxDecoration(
                    image: DecorationImage(image: AssetImage('assets/images/image_login_background.jpg'), fit: BoxFit.fill),
                  ),
                ),
                ListView(
                  children: [
                        ...
                        children: [
                          Container(
                            child: const Row(
                              ...
                              children: [
                                Image(
                                  image: AssetImage('assets/icons/ic_no_bg.jpg'),
                                  height: 100,
                                  width: 100,
                                ),
                                Text(
                                ...
                                children: [
                                  TextField(
                                    ...
                                    decoration: InputDecoration(
                                        ...
                                        hintStyle: const TextStyle(color: Colors.teal, fontWeight: FontWeight.bold),
                                        border: const OutlineInputBorder()),
                                  ),
                                  if (!resultCheckPassword)
                                    Text('Mật khẩu trên 8 ký (ký tự hoa, ký tự thường, số và đặt biệt)',
                                  ...
                                  TextField(
                                    ...
                                    decoration: InputDecoration(
                                        suffixIcon: IconButton(
                                            ...
                                            icon: Icon(isVisibleConfirm ? Icons.visibility_off : Icons.visibility)),
                                        floatingLabelBehavior: FloatingLabelBehavior.always,
                                        labelText: "Confirm",
                            ...
                            child: TextButton(
                              ...
                              child: Text(
                                ...
                                style: const TextStyle(
                                    ...
                                    fontSize: 18,
                                    color: const Color.fromARGB(255, 165, 228, 222)),
                              ),
                              style: ButtonStyle(
                                ...
                                shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                                  RoundedRectangleBorder(
                                    borderRadius: BorderRadius.circular(20.0), // Độ cong của đường viền
                                  ),
                                ),
                              ),
                            ),
